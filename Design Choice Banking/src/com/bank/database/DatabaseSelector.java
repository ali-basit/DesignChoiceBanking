...
public class DatabaseSelector {
   ...
   * @throws SQLException thrown when something goes wrong with query.
   */
  protected static ResultSet getUserDetails2(Connection connection) throws SQLException {
  ...
  /**
   * return all id's in database
   * @param userId the id of the user.
   * @param connection the connection to the database.
   * @return a result set containing all accounts.
   * @throws SQLException thrown when something goes wrong with query.
   */
  protected static ResultSet getAllUserIds(Connection connection) throws SQLException {
    String sql = "SELECT * ID FROM USERS";
    PreparedStatement preparedStatement = connection.prepareStatement(sql);
    return preparedStatement.executeQuery();
  }
